...
namespace Birds.Shared.Localization
{
    public static class AppText
    {
        private static readonly IReadOnlyDictionary<string, string> Russian = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Settings.Data.ExportHint"] = "Изначальное место для экспорта: {0}",
            ["Settings.Data.ImportHint"] = "Импорт объединяет записи по Id: новые добавляются, совпадающие обновляются, а локальные записи вне файла не удаляются.",
            ...
            ["Info.ImportSucceeded"] = "Импорт завершён. Обработано: {0}, добавлено: {1}, обновлено: {2}.",
        ...
        private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Settings.Data.ExportHint"] = "Default export location: {0}",
            ["Settings.Data.ImportHint"] = "Import merges records by Id: new entries are added, matching ones are updated, and local records outside the file remain untouched.",
            ...
            ["Info.ImportSucceeded"] = "Import completed. Processed: {0}, added: {1}, updated: {2}.",
