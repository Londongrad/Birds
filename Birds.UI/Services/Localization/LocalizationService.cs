...
public sealed class LocalizationService : ObservableObject, ILocalizationService
{
    ...
    {
        return AppText.Get(key, CurrentCulture);
    }

    public string GetString(string key, params object[] args)
    {
        return AppText.Format(CurrentCulture, key, args);
    }
    ...
    {
        return DateDisplayFormats.FormatDate(value, CurrentCulture, CurrentDateFormat, style);
    }
    ...
    {
        return DateDisplayFormats.FormatDateTime(value, CurrentCulture, CurrentDateFormat);
    }
