...
public partial class MainViewModel : ObservableObject
{
    ...
    [ObservableProperty] private string headerTitle = AppText.Get("Main.Header.AddBird.Title");

    [ObservableProperty] private bool isNotificationCenterOpen;

    [ObservableProperty] private bool showContentHeader;
        ...
        SettingsViewModel settingsViewModel)
    {
        ...
        Navigation.AddCreator<BirdListViewModel>(() => birdsVM);
        Navigation.AddCreator<AddBirdViewModel>(() => addBirdVM);
        Navigation.AddCreator<BirdStatisticsViewModel>(() => birdStatistics);
        Navigation.AddCreator<SettingsViewModel>(() => settingsViewModel);
        ...
        Navigation.NavigateTo(addBirdVM);
    ...
    private void OnNavigationPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        _currentViewModelType = Navigation.Current?.GetType();
        UpdateHeader(_currentViewModelType);
    }
