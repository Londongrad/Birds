...
public class BoolToStatusTextConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        if (string.Equals(text, AppText.Get("Bird.StatusAlive", CultureInfo.GetCultureInfo(AppLanguages.English)),
                StringComparison.CurrentCultureIgnoreCase))
            return true;

        if (string.Equals(text, AppText.Get("Bird.StatusDead", CultureInfo.GetCultureInfo(AppLanguages.English)),
                StringComparison.CurrentCultureIgnoreCase))
            return false;
