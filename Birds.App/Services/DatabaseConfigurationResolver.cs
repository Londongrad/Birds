...
namespace Birds.App.Services
{
    internal static class DatabaseConfigurationResolver
    {
        ...
        private static string ResolveLocalStoreConnectionString(IConfiguration configuration, DatabaseProvider legacyProvider)
        {
        ...
        private static RemoteSyncRuntimeOptions ResolveRemoteSyncOptions(IConfiguration configuration, DatabaseProvider legacyProvider)
        {
            ...
            var connectionString = ResolveConnectionString(configuration, configuredConnectionName, "Postgres", "DefaultConnection");
    ...
    internal sealed record DatabaseStartupConfiguration(string LocalStoreConnectionString,
